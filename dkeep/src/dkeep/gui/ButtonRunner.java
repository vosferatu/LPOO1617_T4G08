...
public class ButtonRunner {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ButtonRunner window = new ButtonRunner();
	...
	private void initialize() {
		...
		frmDungeonKeep.setLocation(screen.width/2 - frmDungeonKeep.getSize().width/2, 
				screen.height/2 - frmDungeonKeep.getSize().height/2);
